...
//       `http://52.90.240.95:3000/income/deleteIncome/${incomeId}`,
...
//       "http://52.90.240.95:3000/income/addIncome",
//       income,
//       { headers: { Authorization: token } }
//     );
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // axios
  //   .get("http://52.90.240.95:3000/income/getAllIncomes", {
  //     headers: { Authorization: token },
  //   })
  //   .then((res) => {
...
async function buyPremium(e) {
  ...
  const res = await axios.get(
    "http://52.90.240.95:3000/purchase/premiumMembership",
    { headers: { Authorization: token } }
  );
  var options = {
    ...
    handler: async function (response) {
      const res = await axios.post(
        "http://52.90.240.95:3000/purchase/updateTransactionStatus",
        {
...
async function fetchLeaderboardData() {
  try {
    const response = await axios.get(
      "http://52.90.240.95:3000/premium/showLeaderBoard",
      { headers: { Authorization: token } }
    );
...
function updateIncomeBalance() {
  axios
    .get("http://52.90.240.95:3000/income/getTotalIncomes", {
      headers: { Authorization: token },
    })
    .then((res) => {
      console.log("fetched:" + res.data);
...
function updateExpenseBalance() {
  axios
    .get("http://52.90.240.95:3000/expense/getTotalExpenses", {
      headers: { Authorization: token },
    })
    .then((res) => {
      console.log("fetched:" + res.data);
...
async function deleteExpenseRow(btn, ExpenseId) {
  try {
    const response = await axios.delete(
      `http://52.90.240.95:3000/expense/deleteExpense/${ExpenseId}`,
      { headers: { Authorization: token } }
    );
    updateIncomeBalance();
...
async function addNewExpense(e) {
  ...
  try {
    const response = await axios.post(
      "http://52.90.240.95:3000/expense/addExpense",
      Expense,
      { headers: { Authorization: token } }
    );
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const fetchExpenses = async (page, perPage) => {
    try {
      const response = await axios.get(`http://52.90.240.95:3000/expense/getAllExpenses?page=${page}&perPage=${perPage}`, {
        headers: { Authorization: token },
      });
...
async function downloadPDF() {
  ...
  await axios.get("http://52.90.240.95:3000/expense/download", {
    headers: { Authorization: token },
  })
    .then((response) => {
...
async function getAllExpenseLinks() {
  ...
  linksButton.addEventListener("click", async () => {
    ...
    try {
      const response = await axios.get("http://52.90.240.95:3000/expense/getAllLinks", {
        headers: { Authorization: token },
      });
